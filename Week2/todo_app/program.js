...
dbConnection.connect(function (err) {
    ...
    // create
    todoModel.create(1, "R@SHAD", function (err, todoItems) {
        if (err) {
            console.log("error loading TODO items:", err);
        }
        console.log("existing todo items:", todoItems);
    ...
    // update
    todoModel.update(48, "rashad", function (err, todoItems) {
        if (err) {
            console.log("error loading TODO items:", err);
        }
        console.log("existing todo items:", todoItems);
    ...
    // Tag
    todoModel.tagTodoItem(44, 4, function (err, todoItems) {
        if (err) {
            console.log("error loading TODO items:", err);
        }
        console.log("existing todo items:", todoItems);
    ...
    // untag
    todoModel.untagTodoItem(44, 4, function (err, todoItems) {
        if (err) {
            console.log("error loading TODO items:", err);
        }
        console.log("existing todo items:", todoItems);
    ...
    // markCompleted
    todoModel.markCompleted(49, function (err, todoItems) {
        if (err) {
            console.log("error loading TODO items:", err);
        }
        console.log("existing todo items:", todoItems);
