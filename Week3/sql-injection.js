...
async function queryDatabase() {
  ...
  try {
    ...
    // const select_query = `select * from employee WHERE emp_no =  ${input_number};`;
    ...
    // const select_query = `select * from employee WHERE emp_no =` + connection.escape(input_number);
    ...
    const select_query = `select * from employee WHERE emp_no = ?`;
