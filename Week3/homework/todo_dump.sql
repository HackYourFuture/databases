...
INSERT INTO `todoitem` VALUES (1,'clean the house'),(2,'finish the projest'),(3,'do homework'),(4,'eggs');
...
--
-- Table structure for table `todolists_items`
--

DROP TABLE IF EXISTS `todolists_items`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `todolists_items` (
  `todolists_items` tinyint(4) DEFAULT NULL,
  `todoID` int(11) NOT NULL,
  `listID` int(11) NOT NULL,
  PRIMARY KEY (`todoID`,`listID`),
  KEY `listID` (`listID`),
  CONSTRAINT `todolists_items_ibfk_1` FOREIGN KEY (`todoID`) REFERENCES `todoitem` (`todoID`) ON DELETE CASCADE,
  CONSTRAINT `todolists_items_ibfk_2` FOREIGN KEY (`listID`) REFERENCES `todolists` (`listID`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `todolists_items`
--

LOCK TABLES `todolists_items` WRITE;
/*!40000 ALTER TABLE `todolists_items` DISABLE KEYS */;
INSERT INTO `todolists_items` VALUES (1,1,1),(1,2,2),(1,3,3),(1,4,4);
/*!40000 ALTER TABLE `todolists_items` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-08-13 21:44:53
