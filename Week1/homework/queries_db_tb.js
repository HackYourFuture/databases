...
const CreateTableCountry = `CREATE TABLE  country  (
  ...
  Capital  VARCHAR(22) NOT NULL DEFAULT ''
) `;
...
const insertContires = [
    ...
    "INSERT INTO country VALUES ('BVT','Bouvet Island','Antarctica','Antarctica',59.00,NULL,0,NULL,0.00,NULL,'Bouvetoya','Dependent Territory of Norway','Harald V','')",
    ...
    "INSERT INTO country VALUES ('AUT','Austria','Europe','Western Europe',83859.00,1918,8091800,77.7,211860.00,206025.00,'osterreich','Federal Republic','Thomas Klestil','VIENNA')",
    ...
    "INSERT INTO country VALUES ('ARG','Argentina','South America','South America',2780400.00,1816,37032000,75.1,340238.00,323310.00,'Argentina','Federal Republic','Fernando de la Rúa','BUENOS AIRES')",
...
const insertCities = [
    ...
    "INSERT INTO city VALUES (ID,'São Paulo','BRA','São Paulo',9968485)",
    ...
    "INSERT INTO city VALUES (ID,'Ciudad de Mexico','MEX','Distrito Federal',8591309)",
