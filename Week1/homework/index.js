...
db.query('CREATE DATABASE IF NOT EXISTS new_world;', error => {
  if (error) throw error;
  console.log('database created successfully');
});
db.query('USE new_world', function(error) {
  if (error) throw error;
...
const insertIntoCountriesTable =
  'INSERT INTO countries (Code,Name,Continent,Surface_Area,Index_Year,Population,Life_Expectancy,GNP,GNP_Old,Local_Name,Government_Form,Head_Of_State,Capital,Code2,PRIMARYـKEY) VALUES ?';
let countries = [
  [
    189,
    'Aruba',
...
db.query(`SELECT name FROM cities WHERE District="Netherlands"`),
