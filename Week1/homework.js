...
const creater = [databaseWorld, , useDatabase, tableCity, tableCountry];
for (var i in creater) {
  console.log('Going to run ', creater[i]);
  connection.query(creater[i], function(error) {
    if (error) {
      throw error;
    }
